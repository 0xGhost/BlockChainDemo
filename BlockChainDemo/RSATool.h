...
// OpenSSL example code from: https://eclipsesource.com/blogs/2016/09/07/tutorial-code-signing-and-verification-with-openssl/
class RSATool
{
public:
	...
	static char* SignMessage(std::string privateKey, std::string plainText) {
	...
	static bool VerifySignature(std::string publicKey, std::string plainText, char* signatureBase64) {
